...
const Login = () => {
  ...
  const checkAdmin = (email) => {
    fetch(`https://redlight-server.herokuapp.com/isAdmin?email=${email}`)
        ...
        <div className="loginbox-container w-50 mx-auto p-4">
          <Link style={{ textDecoration: "none" }} to="/">
            <h1 className="text-center">
              ...
              <span className="text-danger" style={{ fontSize: "0.4em" }}>
                Wedding
              </span>
            </h1>
          </Link>
          <h2 style={{ marginTop: "6em" }} className="text-dark text-center">
            Login With
          </h2>
